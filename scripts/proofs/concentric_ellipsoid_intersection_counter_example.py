...
C = roty(-np.pi / 4)
box = rg.Box(half_extents=[1, 0.5, 0.5], center=[0, 0, 0])
ell1 = rg.maximum_inscribed_ellipsoid(box.vertices)
...
p1 = C @ p0
P0 = rg.InertialParameters.from_point_masses(masses=[0.5, 0.5], points=[p0, p1])
